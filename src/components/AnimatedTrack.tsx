...
export default function AnimatedTrack({
    ...
    useEffect(() => {
        ...
        tempPath.setAttribute("transform", `translate(${offsetX}, ${offsetY}) scale(${svgScale})`);
    ...
    return (
        <div className={`flex items-center justify-start bg-transparent ${className}`}>
            <svg
            ...
            >
                <g transform={`scale(${0.55 * scale})`}>
                    ...
                    <circle
                        ...
                        fill={dotColor}
                        style={{
                            filter: `drop-shadow(0 0 ${6 / scale}px ${dotColor})`
                        }}
                    />
                </g>
            </svg>
