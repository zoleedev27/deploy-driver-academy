...
import { GalleryFilterKey, GalleryImage, GallerySortOption } from '@/types/gallery.ts';
...
export default function GalleryClient() {
    ...
    const fullscreenImage =
        currentIndex !== null ? getFileUrl(filteredImages[currentIndex]?.name) : null;
        ...
        <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-end items-center mb-6 gap-4 relative">
                ...
                {showFilter && (
                    ...
                    >
                        {(['campaign', 'course', 'year'] satisfies GalleryFilterKey[]).map((categoryKey) => {
                            ...
                            return (
                                <div key={categoryKey} className="mb-4">
                                    <p className="font-semibold capitalize mb-2">{categoryKey}s</p>
                                    ...
                                    {options.length > 6 && (
                                        ...
                                        >
                                            ...
                                            {showAll ? <ChevronUp size={16} className="ml-1" /> : <ChevronDown size={16} className="ml-1" />}
                                        </button>
                                    )}
                                </div>
                            );
                            ...
                            <div key={key} className="flex justify-between items-center mb-3">
                                ...
                                <div className="flex gap-1">
                                    <button
                                        ...
                                        onClick={() => {
                                            const newSort: { key: keyof GalleryImage; order: 'asc' | 'desc' } = { key, order: 'asc' };
                                            setSortBy(newSort);
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            const newSort: { key: keyof GalleryImage; order: 'asc' | 'desc' } = { key, order: 'desc' };
                                            setSortBy(newSort);
            ...
            <ResponsiveMasonry columnsCountBreakPoints={{ 0: 1, 320: 2, 768: 3, 1024: 4 }}>
                <Masonry gutter="10px">
