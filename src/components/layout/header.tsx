      ...
      <header className="sticky top-0 z-50 bg-background border-b border-black dark:border-white w-full transition-all duration-300">
        <div className="px-4 flex h-14 items-center justify-between sm:h-12 md:h-14 lg:h-16 xl:h-18 2xl:h-20">
          <div className="flex items-center gap-1 sm:gap-2 md:gap-2 lg:gap-3 xl:gap-4 2xl:gap-5">
            ...
            <Link
              href="/"
              className="font-bodyfont-bold text-sm sm:text-md md:text-lg lg:text-lg xl:text-xl 2xl:text-2xl"
            >
              Go Kart Cluj
            </Link>
          </div>

          <nav className="hidden md:flex items-center justify-center flex-1 md:space-x-3 lg:space-x-5 xl:space-x-8 2xl:space-x-10">
            {NAV_LINKS.map((item) => {
              ...
              return (
                ...
                >
                  {IconComponent && (
                    <IconComponent
                      size={20}
                      className="md:mb-1 lg:mb-0 lg:mr-2 xl:mr-2 2xl:mr-3"
                    />
                  )}
          ...
          <div className="hidden md:flex md:items-center md:gap-4">
            ...
            {isLogged ? (
              <div className="hidden md:flex md:items-center md:gap-2">
                ...
                <Avatar className="h-8 w-8 xl:h-9 xl:w-9 2xl:h-9 2xl:w-9 cursor-pointer hover:scale-105">
            ...
            <div>
              <Drawer direction="bottom" open={isOpen} onOpenChange={setIsOpen}>
                <DrawerTrigger asChild>
                  <div className="rounded-l-md p-2 flex flex-col items-center justify-center cursor-pointer">
